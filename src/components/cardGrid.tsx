...
const HearthstoneGrid = () => {
    ...
    const setInfo: { [key: string]: SetInfo } = {
        'HEROES_OF_STARCRAFT': { order: 43, date: 'January 31, 2025', isMiniSet: true, apiName: 'HEROES_OF_STARCRAFT' },
        'THE_GREAT_DARK_BEYOND': { order: 42, date: 'November 5, 2024', isMiniSet: false, apiName: 'GREAT_DARK_BEYOND' },
        'THE_TRAVELING_TRAVEL_AGENCY': { order: 41, date: 'September 10, 2024', isMiniSet: true, apiName: 'TRAVELING_TRAVEL_AGENCY' },
        'PERILS_IN_PARADISE': { order: 40, date: 'July 23, 2024', isMiniSet: false, apiName: 'PERILS_IN_PARADISE' },
        'DR_BOOMS_INCREDIBLE_INVENTIONS': { order: 39, date: 'May 14, 2024', isMiniSet: true, apiName: 'BOOMS_INVENTIONS' },
        'WHIZBANGS_WORKSHOP': { order: 38, date: 'March 19, 2024', isMiniSet: false, apiName: 'WHIZBANGS_WORKSHOP' },
        'DELVE_INTO_DEEPHOLM': { order: 37, date: 'January 18, 2024', isMiniSet: true, apiName: 'DELVE_INTO_DEEPHOLM' },
        'SHOWDOWN_IN_THE_BADLANDS': { order: 36, date: 'November 14, 2023', isMiniSet: false, apiName: 'BADLANDS' },
        'FALL_OF_ULDUAR': { order: 35, date: 'September 19, 2023', isMiniSet: true, apiName: 'FALL_OF_ULDUAR' },
        'TITANS': { order: 34, date: 'August 1, 2023', isMiniSet: false, apiName: 'TITANS' },
        'AUDIOPOCALYPSE': { order: 33, date: 'May 31, 2023', isMiniSet: true, apiName: 'AUDIOPOCALYPSE' },
        'FESTIVAL_OF_LEGENDS': { order: 32, date: 'April 11, 2023', isMiniSet: false, apiName: 'FESTIVAL' },
        'RETURN_TO_NAXXRAMAS': { order: 31, date: 'February 14, 2023', isMiniSet: true, apiName: 'RETURN_TO_NAXXRAMAS' },
        'MARCH_OF_THE_LICH_KING': { order: 30, date: 'December 6, 2022', isMiniSet: false, apiName: 'RETURN_OF_THE_LICH_KING' },
        'MAW_AND_DISORDER': { order: 29, date: 'September 27, 2022', isMiniSet: true, apiName: 'MAW_AND_DISORDER' },
        'MURDER_AT_CASTLE_NATHRIA': { order: 28, date: 'August 2, 2022', isMiniSet: false, apiName: 'MURDER_AT_CASTLE_NATHRIA' },
        'THRONE_OF_THE_TIDES': { order: 27, date: 'June 1, 2022', isMiniSet: true, apiName: 'THRONE_OF_THE_TIDES' },
        'VOYAGE_TO_THE_SUNKEN_CITY': { order: 26, date: 'April 12, 2022', isMiniSet: false, apiName: 'VOYAGE_TO_THE_SUNKEN_CITY' },
        'ONYXIAS_LAIR': { order: 25, date: 'February 15, 2022', isMiniSet: true, apiName: 'ONYXIAS_LAIR' },
        'FRACTURED_IN_ALTERAC_VALLEY': { order: 24, date: 'December 7, 2021', isMiniSet: false, apiName: 'ALTERAC_VALLEY' },
        'DEADMINES': { order: 23, date: 'November 2, 2021', isMiniSet: true, apiName: 'DEADMINES' },
        'UNITED_IN_STORMWIND': { order: 22, date: 'August 3, 2021', isMiniSet: false, apiName: 'STORMWIND' },
        'WAILING_CAVERNS': { order: 21, date: 'June 3, 2021', isMiniSet: true, apiName: 'WAILING_CAVERNS' },
        'FORGED_IN_THE_BARRENS': { order: 20, date: 'March 30, 2021', isMiniSet: false, apiName: 'THE_BARRENS' },
        'DARKMOON_RACES': { order: 19, date: 'January 21, 2021', isMiniSet: true, apiName: 'DARKMOON_RACES' },
        'MADNESS_AT_THE_DARKMOON_FAIRE': { order: 18, date: 'November 17, 2020', isMiniSet: false, apiName: 'DARKMOON_FAIRE' },
        'SCHOLOMANCE_ACADEMY': { order: 17, date: 'August 6, 2020', isMiniSet: false, apiName: 'SCHOLOMANCE' },
        'ASHES_OF_OUTLAND': { order: 16, date: 'April 7, 2020', isMiniSet: false, apiName: 'BLACK_TEMPLE' },
        'DESCENT_OF_DRAGONS': { order: 15, date: 'December 10, 2019', isMiniSet: false, apiName: 'DRAGONS' },
        'SAVIORS_OF_ULDUM': { order: 14, date: 'August 6, 2019', isMiniSet: false, apiName: 'ULDUM' },
        'RISE_OF_SHADOWS': { order: 13, date: 'April 9, 2019', isMiniSet: false, apiName: 'DALARAN' },
        'RASTAKHANS_RUMBLE': { order: 12, date: 'December 4, 2018', isMiniSet: false, apiName: 'TROLL' },
        'THE_BOOMSDAY_PROJECT': { order: 11, date: 'August 7, 2018', isMiniSet: false, apiName: 'BOOMSDAY' },
        'THE_WITCHWOOD': { order: 10, date: 'April 12, 2018', isMiniSet: false, apiName: 'GILNEAS' },
        'KOBOLDS_AND_CATACOMBS': { order: 9, date: 'December 7, 2017', isMiniSet: false, apiName: 'LOOTAPALOOZA' },
        'KNIGHTS_OF_THE_FROZEN_THRONE': { order: 8, date: 'August 10, 2017', isMiniSet: false, apiName: 'ICCA' },
        'JOURNEY_TO_UNGORO': { order: 7, date: 'April 6, 2017', isMiniSet: false, apiName: 'UNGORO' },
        'MEAN_STREETS_OF_GADGETZAN': { order: 6, date: 'December 1, 2016', isMiniSet: false, apiName: 'GANGS' },
        'WHISPERS_OF_THE_OLD_GODS': { order: 5, date: 'April 26, 2016', isMiniSet: false, apiName: 'OG' },
        'THE_GRAND_TOURNAMENT': { order: 4, date: 'August 24, 2015', isMiniSet: false, apiName: 'TGT' },
        'GOBLINS_VS_GNOMES': { order: 3, date: 'December 8, 2014', isMiniSet: false, apiName: 'GVG' },
    ...
    const classes = Array.from(new Set(cards.map(card => card.cardClass).filter(Boolean))).sort();
    
    // Get all sets from setInfo, ensuring we show all sets even if there are no cards yet
    const sets = Object.keys(setInfo)
        .sort((a, b) => setInfo[b].order - setInfo[a].order); // Sort by order (newest first)
    ...
    useEffect(() => {
        const fetchCards = async () => {
            ...
            try {
                ...
                const validCards = data.filter((card: Card) => 
                    card.id && 
                        ...
                        {sets.map(setName => (
                            <MenuItem 
                                ...
                                sx={{
                                    ...
                                    fontSize: setInfo[setName]?.isMiniSet ? '0.9em' : '1em',
                                    color: setInfo[setName]?.isMiniSet ? 'text.secondary' : 'text.primary'
                                }}
                            >
